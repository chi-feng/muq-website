...
<h3 id="Full-example-files">Full example files</h3><p>On each example webpage, all code snippets are concatenated into a complete listing at the bottom of the page.  This completed code can be copied and used in your own applications.</p>
